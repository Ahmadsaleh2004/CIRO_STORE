...
| **Size** | <!--stats:php-->27,199 lines of PHP<!--/stats:php--> · <!--stats:js-->7,206 JS<!--/stats:js--> · <!--stats:css-->5,583 CSS<!--/stats:css--> |
| **Tests** | <!--stats:tests-->273 tests<!--/stats:tests--> (unit + integration + browser) |
