...
| **الحجم** | ‏<!--stats:php-->26,185 سطر PHP<!--/stats:php--> · <!--stats:js-->6,310 JS<!--/stats:js--> · <!--stats:css-->5,470 CSS<!--/stats:css--> |
| **الاختبارات** | <!--stats:tests-->246 اختباراً<!--/stats:tests--> (وحدة + تكامل) |
