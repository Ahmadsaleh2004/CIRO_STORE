...
| **Size** | <!--stats:php-->27,413 lines of PHP<!--/stats:php--> · <!--stats:js-->7,317 JS<!--/stats:js--> · <!--stats:css-->6,029 CSS<!--/stats:css--> |
| **Tests** | <!--stats:tests-->305 tests<!--/stats:tests--> (unit + integration + browser) |
