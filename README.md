...
| **Size** | <!--stats:php-->27,503 lines of PHP<!--/stats:php--> · <!--stats:js-->7,542 JS<!--/stats:js--> · <!--stats:css-->6,055 CSS<!--/stats:css--> |
| **Tests** | <!--stats:tests-->312 tests<!--/stats:tests--> (unit + integration + browser) |
