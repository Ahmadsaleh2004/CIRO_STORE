...
abstract class DatabaseTestCase extends TestCase
{
     ...
     *
     * الأداء ليس تفصيلاً هنا. النسخة الأولى كانت تُصدر `SHOW TABLES`
     * ثم TRUNCATE منفصلاً لكل جدول — 29 رحلة ذهاب وإياب لكل اختبار،
     * أي **ثلاث ثوان للاختبار الواحد** و36 ثانية لاثني عشر اختباراً.
     * مجموعة اختبارات بهذا البطء لا تُشغَّل، ومجموعة لا تُشغَّل لا
     * تحمي شيئاً.
     *
     * الآن: قائمة الجداول تُقرأ مرّة واحدة وتُبنى منها عبارة واحدة
     * تُنفَّذ برحلة واحدة.
     */
